    ...
    >
      <div class="mx-8 border-b border-solid border-brand-gray-2 pt-5 pb-2">
        ...
        <div class="flex flex-row align-middle">
          <div class="mr-5"><span>Job</span></div>
      ...
      <div class="px-8 py-4">
        ...
        <div>
          <ul class="list-disc pl-8">
            <li>Bachelors's degree or equivalent practical experience.</li>
            <li>5 years of experience in programm managment</li>
            <li>
              Experience analyzing data through queriying database(e.g. SQL) using spreadsheet
